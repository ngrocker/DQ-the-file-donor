...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"📂 <em>🤩File Name😍</em>: <code>❤️MALLUROCKERSCLUB BOT™|{file_name}</code> \n\n🖇 <em>💾File Size</em>: <code>{file_size}🌀</code> </i>Join</i> [⚡️MALLUROCKERS CLUB🚬](https://t.me/MALLUROCKERSCLUB) \n\n🖥 <i>Requests</i> - ||😘@NGROCKER😎||"")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", f"📂 <em>🤩File Name😍</em>: <code>❤️MALLUROCKERSCLUB BOT™|{file_name}</code> \n\n🖇 <em>💾File Size</em>: <code>{file_size}🌀</code> </i>Join</i> [⚡️MALLUROCKERS CLUB🚬](https://t.me/MALLUROCKERSCLUB) \n\n🖥 <i>Requests</i> - ||😘@NGROCKER😎||"")
