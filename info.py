...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MRCupdate')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📂 <em>File Name</em>: <code>MRCUPDATE™|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> </i>Join</i> [⚡️MRC UPDATE🚬](https://t.me/MRCUPDATE)  \n\n🖥 <i>Requests</i> - ||@NGROCKER||")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "📂 <em>File Name</em>: <code>MRCUPDATE™|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> </i>Join</i> [⚡️MRC UPDATE 🚬](https://t.me/MRCUPDATE)  \n\n🖥 <i>Requests</i> - ||@NGROCKER||") 
